...
#define MyAppName "B-Cephal-Archive-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Archive-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8DBD5CB1-7D4E-AC45-36A5-F1BADF452676}
...
DefaultDirName={pf}\Moriset\Bcephal\8\Archive-Service
DefaultGroupName=Moriset\Bcephal\8\Archive-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Archive Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Archive Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Archive Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
