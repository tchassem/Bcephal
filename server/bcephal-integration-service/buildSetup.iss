...
#define MyAppName "B-Cephal-Integration-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Integration-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8DBD3CB1-9D4E-AC45-67A5-F6BDAE827656}
AppName=B-Cephal Integration Service
AppVerName=B-Cephal Integration Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Integration-Service
DefaultGroupName=Moriset\Bcephal\8\Integration-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Integration Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Integration Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Integration Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
