CREATE TABLE IF NOT EXISTS BCP_TRANSFORMATION_ROUTINE_SPOT_CONDITION (
	id BIGINT not null,	
	spotId BIGINT,
...
CREATE SEQUENCE IF NOT EXISTS transformation_routine_spot_cond_seq START WITH 1 INCREMENT BY 1;
