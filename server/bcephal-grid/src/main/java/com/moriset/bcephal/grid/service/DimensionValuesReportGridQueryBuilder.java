...
public class DimensionValuesReportGridQueryBuilder extends ReportGridQueryBuilder {
	...
	public DimensionValuesReportGridQueryBuilder(DimensionDataFilter filter) {
		super(filter);
		this.filter = filter;
	}
