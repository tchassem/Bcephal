 ...
 *         16 juin 2016
 */
public class MaterializedExporter {
	...
	public MaterializedExporter() {
		logger = LoggerFactory.getLogger(getClass().getName());
		datePositions = new ArrayList<>(0);

	}

	public MaterializedExporter(MaterializedGrid grid, List<Long> ids, boolean exportAllColumns) {
		this();
	...
	public void export(String path, MaterializedGrid grid, List<Object[]> objects, boolean ignoreLastColumn) throws IOException {
	...
	protected void writeHeaders(MaterializedGrid grid) {
	...
	protected void writeHeaderss(MaterializedGrid grid) {
