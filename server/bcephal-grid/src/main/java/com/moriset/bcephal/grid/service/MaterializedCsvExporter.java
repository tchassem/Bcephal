...
public class MaterializedCsvExporter {
	...
	public MaterializedCsvExporter(String path, MaterializedGrid grid, boolean ignoreLastColumn, List<Long> ids, boolean exportAllColumns) throws IOException {
	...
	private void formatData(List<Object[]> items) {		
		for (MaterializedGridColumn col : grid.getColumns()) {
	...
	protected void writeHeaders(MaterializedGrid grid, PrintWriter writer, boolean ignoreLastColumn) {
