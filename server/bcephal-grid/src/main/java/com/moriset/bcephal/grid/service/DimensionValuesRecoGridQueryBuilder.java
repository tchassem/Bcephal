...
public class DimensionValuesRecoGridQueryBuilder extends ReconciliationGridQueryBuilder {
	...
	public DimensionValuesRecoGridQueryBuilder(DimensionDataFilter filter) {
		super(filter);
		this.filter = filter;
	}
