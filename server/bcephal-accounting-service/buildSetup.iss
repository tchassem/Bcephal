...
#define MyAppName "B-Cephal-Accounting-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Accounting-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8DBD6CB1-9ABE-AC45-37A8-F9BDAF823376}
AppName=B-Cephal Accounting Service
AppVerName=B-Cephal Accounting Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Accounting-Service
DefaultGroupName=Moriset\Bcephal\8\Accounting-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Accounting Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Accounting Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Accounting Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
