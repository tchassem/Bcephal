...
import com.moriset.bcephal.loader.service.FileLoaderLogService;
 ...
 */
@RestController
@RequestMapping("/sourcing/file-loader-log")
@Slf4j
public class FileLoaderLogController {

	@Autowired
	FileLoaderLogService logService;
	...
	public ResponseEntity<?> search(@RequestBody BrowserDataFilter filter,
		...
		try {
			BrowserDataPage<FileLoaderLog> page = logService.search(filter, locale);
