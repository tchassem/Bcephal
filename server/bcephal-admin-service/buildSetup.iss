...
AppName=B-Cephal Admin Service
AppVerName=B-Cephal Admin Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Admin-Service
DefaultGroupName=Moriset\Bcephal\8\Admin-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Admin Service
Compression=lzma
