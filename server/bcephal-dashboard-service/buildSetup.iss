...
#define MyAppName "B-Cephal-Dashboard-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Dashboard-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8DBD3CB1-9D4E-AC45-36A5-F6BDCF823656}
AppName=B-Cephal Dashboard Service
AppVerName=B-Cephal Dashboard Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Dashboard-Service
DefaultGroupName=Moriset\Bcephal\8\Dashboard-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Dashboard Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Dashboard Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Dashboard Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
