...
@RestController
@RequestMapping("/billing/company-repository")
@Slf4j
public class BillingCompanyRepositoryController  extends BaseController<MaterializedGrid, BrowserData> {
	...
	@Override
	protected BillingCompanyRepositoryService getService() {
		return billingCompanyRepositoryService;
	}
	...
	public ResponseEntity<?> duplicateRows(@PathVariable Long matGridId, @RequestBody List<Long> ids, JwtAuthenticationToken principal, @RequestHeader("Accept-Language") java.util.Locale locale) {
	...
	public ResponseEntity<?> editCell(@RequestBody MaterializedGridEditedElement element, JwtAuthenticationToken principal, @RequestHeader("Accept-Language") java.util.Locale locale) {
	...
	public ResponseEntity<?> editCell(@RequestBody List<MaterializedGridEditedElement> elements, JwtAuthenticationToken principal, @RequestHeader("Accept-Language") java.util.Locale locale) {
	...
	public ResponseEntity<?> getGridColumns(JwtAuthenticationToken principal, @PathVariable("matGridId") Long matGridId, @RequestHeader("Accept-Language") java.util.Locale locale) {
		...
		try {
			List<MaterializedGridColumn> columns = getService().getColumns(matGridId);
