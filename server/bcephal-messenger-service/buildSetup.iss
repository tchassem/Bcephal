...
#define MyAppName "B-Cephal-Messenger-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Messenger-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8BD48CB1-9D9E-AC85-36A7-F6BCBE797052}
AppName=B-Cephal Messenger Service
AppVerName=B-Cephal Messenger Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Messenger-Service
DefaultGroupName=Moriset\Bcephal\8\Messenger-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Messenger Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Messenger Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Messenger Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
