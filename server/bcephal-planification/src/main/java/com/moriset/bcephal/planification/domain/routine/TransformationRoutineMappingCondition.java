...
@Entity(name = "TransformationRoutineMappingCondition")
@Table(name = "BCP_TRANSFORMATION_ROUTINE_MAPPING_CONDITION")
@Data
@EqualsAndHashCode(callSuper = false)
public class TransformationRoutineMappingCondition extends Persistent {
	
	private static final long serialVersionUID = -1958445184979523018L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "transformation_routine_mapping_cond_seq")
	@SequenceGenerator(name = "transformation_routine_mapping_cond_seq", sequenceName = "transformation_routine_mapping_cond_seq", initialValue = 1,  allocationSize = 1)
	private Long id;
	...
	private TransformationRoutineMapping mappingId;
...
//			
//	@Enumerated(EnumType.STRING) 
//	private MappingPeriodCondition periodCondition;
//	
...
//	private PeriodGranularity dateGranularity;
	...
	public TransformationRoutineMappingCondition() {
		ignoreCase = true;
	...
	@JsonIgnore
	@Override
	public TransformationRoutineMappingCondition copy() {
		TransformationRoutineMappingCondition copy = new TransformationRoutineMappingCondition();
