...
#define MyAppName "B-Cephal-Gateway-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Gateway-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8DBD3CB1-9D4E-AC45-36A5-F6BDAE827503}
AppName=B-Cephal Gateway Service
AppVerName=B-Cephal Gateway Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Gateway-Service
DefaultGroupName=Moriset\Bcephal\8\Gateway-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Gateway Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Gateway Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Gateway Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
