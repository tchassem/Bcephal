...
@Slf4j
@Import(OtherJpaSecurityConfiguration.class)
public class MultiTenantJpaSecurityConfiguration
	...
	public static final String SECURITY_TRANSACTION_MANAGER_FACTORY = "lcontainerEntityManagerFactoryBean";
	...
	private ISecurityConfiguration iSecurityConfiguration;
	...
	public String[] getPackagesToScanForSecurity() {
		if(iSecurityConfiguration != null) {
			List<String> items = iSecurityConfiguration.getPackagesToScanForSecurity();
			items.add(UserData.class.getPackage().getName());
			items.add(Project.class.getPackage().getName());
			return items.toArray(new String[items.size()]);
		}
		return new String[] { UserData.class.getPackage().getName(),Project.class.getPackage().getName() };
	}
