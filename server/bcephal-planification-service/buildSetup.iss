...
#define MyAppName "B-Cephal-Planifiation-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Planifiation-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{9DBD4CB1-9D4E-AC45-36A5-F6BDAE827656}
AppName=B-Cephal Planifiation Service
AppVerName=B-Cephal Planifiation Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Planifiation-Service
DefaultGroupName=Moriset\Bcephal\8\Planifiation-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Planifiation Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Planifiation Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Planifiation Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
