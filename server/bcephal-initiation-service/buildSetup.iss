...
#define MyAppName "B-Cephal-Initiation-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Initiation-Service.exe"
...
AppName=B-Cephal Initiation Service
AppVerName=B-Cephal Initiation Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Initiation-Service
DefaultGroupName=Moriset\Bcephal\8\Initiation-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Initiation Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Initiation Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Initiation Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
