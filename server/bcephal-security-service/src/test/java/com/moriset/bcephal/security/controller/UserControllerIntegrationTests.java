...
import com.moriset.bcephal.security.UserFactory;
...
public class UserControllerIntegrationTests {
	...
	public void setUp() throws Exception {
		baseUrl = "http://localhost:".concat("" + port).concat("/users");
		buildToken();
	}
	...
	public void saveUserTest() throws Exception {
		...
		List<User> users = UserFactory.BuildUsers();
