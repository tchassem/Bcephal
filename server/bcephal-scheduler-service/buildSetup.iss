...
#define MyAppName "B-Cephal-Scheduler-Service" 
#define MyAppVersion "8.0.0"
#define MyAppPublisher "Moriset"
#define MyAppURL "http://www.moriset.com/"
#define MyAppExeName "B-Cephal-Scheduler-Service.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{8DBD9CB1-9D8E-ACC5-36A5-F6DDAE827656}
AppName=B-Cephal Scheduler Service
AppVerName=B-Cephal Scheduler Service
...
DefaultDirName={pf}\Moriset\Bcephal\8\Scheduler-Service
DefaultGroupName=Moriset\Bcephal\8\Scheduler-Service
OutputDir=.\
OutputBaseFilename=B-Cephal Scheduler Service
Compression=lzma
...
[Icons]
Name: {group}\{cm:UninstallProgram,Bcephal Scheduler Service}; Filename: {uninstallexe}

[Run]  
 Filename: {app}\installService.bat; Description: "Run Bcephal Scheduler Service like Windows Service"; Flags: runhidden runascurrentuser hidewizard postinstall waituntilidle skipifsilent 
